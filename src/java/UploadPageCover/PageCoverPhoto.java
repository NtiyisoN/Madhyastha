...
public class PageCoverPhoto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Part part1 = request.getPart("cover");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //need to change the method from  DatabaseManagement to Query Page

            DatabaseManagement db = new DatabaseManagement();
            
            if(db.insertDataIntoProfileCover(time+exten, numbers)==true){            
