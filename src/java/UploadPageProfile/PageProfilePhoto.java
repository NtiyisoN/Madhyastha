 ...
 */
@MultipartConfig()
public class PageProfilePhoto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id2 =request.getParameter("completeURL");
        
        System.out.print("THIS IS THE NAME OF THE PAGE ------------------->"+id2);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            //need to change the method from  DatabaseManagement to QueryOfPage
