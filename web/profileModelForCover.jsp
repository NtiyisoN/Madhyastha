...
<html>
    <head>
        ...
        <style>       
            ...
            .modal-profile {display: none; position: fixed;z-index: 1;padding-top: 100px; left: 0;top: 0;width: 100%;height: 100%; overflow: auto;  background-color: rgba(0,0,0,0.4);}
            /* Modal Content */
    ...
    <body>
         ...
         <div id="myModal" class="modal-profile">
             ...
             <div class="modal-content aa-animate-top" style="">
                 ...
                 <div>
                   <h3>Upload cover photo or choose from uploaded photos.</h3>
                 </div>
                             
                 <form action="PageCoverPhoto"  method="POST" enctype="multipart/form-data">
                     ...
                     <div style="width: 100%; height: 350px; border:1px solid #ccc;">
                         ...
                         <div style="width: 50%; height: 100%; float: left;">
                             ...
                             <input type="file"  name="cover" id="upload-file"  onchange="readURL(this);" >
                         ...
                         <div style="width: 50%; height: 100%; float: right;">
                             ...
                             <div class="lable-upload-preview aa-ripple">
                                 <img id="blah" src="https://www.cal-sailing.org/components/com_easyblog/themes/wireframe/images/placeholder-image.png" alt="your image" />
                             </div>
                         </div>   
